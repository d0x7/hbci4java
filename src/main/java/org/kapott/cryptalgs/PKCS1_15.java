...
public class PKCS1_15 extends SignatureSpi {
    ...
    private static byte[] sign(SignatureParamSpec spec, PrivateKey privKey, byte[] msg) {
        ...
        if (privKey instanceof RSAPrivateKey) {
            ...
            bModulus =
                    ((RSAPrivateCrtKey2) privKey)
                            .getP()
                            .multiply(((RSAPrivateCrtKey2) privKey).getQ());
        }
    ...
    private static boolean verify(
            SignatureParamSpec spec, PublicKey pubKey, byte[] msg, byte[] signature) {
    ...
    protected void engineSetParameter(AlgorithmParameterSpec params)
        ...
        if (params instanceof SignatureParamSpec) this.param = (SignatureParamSpec) (params);
        else {
