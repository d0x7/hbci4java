...
public class SyntaxAN extends SyntaxDE {
    /**
     * @internal @brief Creates a data element for storing alphanumeric data, used while creating a
     *     message
     * @see SyntaxDE
     */
    ...
    /**
     * @param res A part of the HBCI-message to be parsed. From this (sub-)string the first token
     *     will be used to initialize the data element.
     * @param minsize The minimum string length for this element.
     * @param maxsize The maximum string length for this element (or zero). See
     *     SyntaxDE::setContent(String,int,int,int).
     * @internal
     * @brief Creates a data element for storing alphanumeric data, used while parsing a message.
     *     <p>This constructor creates a new data element from a given HBCI message. For this the
     *     first token in the HBCI message will be extracted from @p res and used as init value for
     *     the data element
     */
