...
/**
 * Dieses Tool ist nur für die interne Verwendung für die Entwicklung von HBCI4Java gedacht. Die
 * XML-Dateien mit den HBCI-Syntax-Beschreibungen werden zum Teil automatisch erzeugt. Mit diesem
 * Tool können die dafür benötigten Templates auf Konsistenz geprüft werden.
 */
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < l; i++) {
            ...
            if (segcode == null || segversion == null) {
                System.out.println(
                        "warning: SEGdef with id " + segdefid + " has no segcode or no segversion");
