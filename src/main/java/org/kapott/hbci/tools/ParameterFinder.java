/**
 * ******************************************************************** $Source:
 * /cvsroot/hibiscus/hbci4java/src/org/kapott/hbci/tools/ParameterFinder.java,v $ $Revision: 1.1 $
 * $Date: 2011/05/13 15:22:08 $ $Author: willuhn $
 *
...
public class ParameterFinder {
     ...
     * @param path der Pfad. Es koennen Wildcards verwendet werden. Etwa so:
     *     Params_*.TAN2StepPar*.ParTAN2Step*.TAN2StepParams*.*secfunc")
     * @return Liefert die gefundenen Properties. Als Schluessel wird jeweils nicht der gesamte Pfad
     *     verwendet sondern nur der Teil hinter dem letzten Punkt.
     */
    public static Properties find(Properties props, String path) {
        // Kein Pfad angegeben. Also treffen alle.
        if (path == null || path.length() == 0) return props;
    ...
    public static void main(String[] args) {
        ...
        Properties result =
                find(props, "Params_*.TAN2StepPar*.ParTAN2Step*.TAN2StepParams*.*secfunc");
 ...
 * $ Revision 1.1 2011/05/13 15:22:08 willuhn @N Hilfsklasse zum Suchen von Parametern in BPD/UPD
 *
 * <p>********************************************************************
 */
