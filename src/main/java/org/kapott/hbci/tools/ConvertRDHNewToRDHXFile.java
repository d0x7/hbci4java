...
public class ConvertRDHNewToRDHXFile {
    public static void main(String[] args) throws IOException {
        ...
        HBCIPassportInternal passportNew =
                (HBCIPassportInternal) AbstractHBCIPassport.getInstance("RDHXFile");
        ...
        ((HBCIPassportRDHXFile) passportNew)
        ...
        ((HBCIPassportRDHXFile) passportNew)
                .setProfileVersion(((AbstractRDHSWPassport) passportOld).getProfileVersion());
