...
/**
 * Tool zum Konvertieren von SIZ-RDH-Schlüsseldateien in RDHNew-Dateien. SIZ-RDH-Schlüsseldateien
 * werden von HBCI-Software verwendet, die auf dem SIZ-HBCI-Kernel basiert (z.B. von
 * <em>StarMoney</em>).
 *
 * <p>Die Konvertierung kann auch mit dem separat verfügbaren <em>HBCI4Java Passport Editor</em>
 * durchgeführt werden.
 *
 * <p>Soll der HBCI-Zugang sowohl mit der ursprünglichen Software als auch parallel dazu mit
 * <em>HBCI4Java</em> benutzt werden, so ist eine Konvertierung der Schlüsseldatei nicht zu
 * empfehlen. Statt dessen sollte die Schlüsseldatei direkt benutzt werden. Dafür kann die
 * Passport-Variante {@link org.kapott.hbci.passport.HBCIPassportSIZRDHFile} benutzt werden.
 *
 * <p>Siehe dazu auch die Datei <code>README.SIZRDHFile</code>
 *
 ...
 * existierenden SIZ-RDH-Schlüsseldatei sowie nach dem Usernamen und Passwort für deren
 * Entschlüsselung gefragt. Anschließend wird nach einem <em>neuen(!)</em> Dateinamen für die zu
 * erstellende RDHNew-Passport-Datei sowie nach einem Passwort für deren Verschlüsselung gefragt.
 * Nach Beendigung des Programmes existiert die RDHNew-Passport-Datei, welche ab sofort benutzt
 * werden kann.
 */
...
public class ConvertSIZRDHPassport {
    public static void main(String[] args) throws IOException {
        ...
        HBCIPassportInternal passportOld =
                (HBCIPassportInternal) AbstractHBCIPassport.getInstance("SIZRDHFile");
