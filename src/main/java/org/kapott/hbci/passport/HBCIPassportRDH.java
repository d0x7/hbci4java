...
/**
 * <em><b>Veraltete</b></em> Passport-Klasse für RDH-Zugänge mit Sicherheitsmedium "Datei". Diese
 * Klasse sollte nicht mehr benutzt werden, sondern statt dessen die Klasse {@link
 * org.kapott.hbci.passport.HBCIPassportRDHNew}. RDH-Passport-Datei können mit dem Tool {@link
 * org.kapott.hbci.tools.ConvertRDHPassport} oder mit Hilfe des separat verfügbaren <em>HBCI4Java
 * Passport Editors</em> in RDHNew-Passport-Dateien umgewandelt werden. Siehe dazu auch die Daten
 * <code>README.RDHNew</code>
 *
 * <p>Das API dieser Klasse ist identisch zu dem der Klasse {@link
 * org.kapott.hbci.passport.HBCIPassportRDHNew}. Siehe Beschreibung dort..
 */
        ...
        if (init) {
            ...
            try {
                ...
                if (k != null && k.key != null && !(k.key instanceof RSAPrivateCrtKey)) {
                    HBCIUtils.log(
                            "private sig key is no CRT key, please contact the author!",
                            HBCIUtils.LOG_WARN);
                }
                ...
                if (k != null && k.key != null && !(k.key instanceof RSAPrivateCrtKey)) {
                    HBCIUtils.log(
                            "private enc key is no CRT key, please contact the author!",
                            HBCIUtils.LOG_WARN);
                }
            } catch (Exception e) {
