...
/**
 * Interface, welches alle Passport-Varianten implementieren müssen. Diese Schnittstelle wird nur
 * intern verwendet. Sie beschreibt alle Methoden, die ein Passport zur Verfügung stellen muss, um
 * von <em>HBCI4Java</em> benutzt werden zu können. Dieses Interface ist nicht zur Anwendung hin
 * sichtbar (deshalb auch "<code>Internal</code>").
 */
