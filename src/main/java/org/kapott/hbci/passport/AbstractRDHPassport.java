        ...
        switch (profile) {
            ...
            default:
                ...
                throw new HBCI_Exception(
                        "*** dont know which sigmode to use for profile rdh-" + profile);
        }
    ...
    public String getCryptMode() {
        ...
        switch (profile) {
            ...
            default:
                ...
                // RDH5: PKCS1
                throw new HBCI_Exception(
                        "*** dont know which cryptmode to use for profile rdh-" + profile);
        }
    ...
    protected int getCryptDataSize(Key key) {
        ...
        switch (profile) {
            ...
            default:
                // TODO das später vom security profile abhängig machen
                throw new HBCI_Exception(
                        "*** dont know which crypt data size to use for profile rdh-" + profile);
        }
    ...
    public String getHashAlg() {
        ...
        switch (profile) {
            ...
            default:
                ...
                // RDH5: SHA
                throw new HBCI_Exception(
                        "*** dont know which hashalg to use for profile rdh-" + profile);
        }
    ...
    public SignatureParamSpec getSignatureParamSpec() {
        ...
        switch (profile) {
            ...
            default:
                // TODO das später vom security profile abhängig machen
                throw new HBCI_Exception(
                        "*** dont know which hash instance to use for profile rdh-" + profile);
        }
    ...
    protected Signature getSignatureInstance() {
        ...
        switch (profile) {
            ...
            default:
                // TODO das später vom security profile abhängig machen
                throw new HBCI_Exception(
                        "*** dont know which signature instance to use for profile rdh-" + profile);
        }
