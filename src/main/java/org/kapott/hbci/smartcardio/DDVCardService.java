...
/**
 * Abstrakter DDV-Cardservice fuer den DDVPCSC-Passport, basierend auf dem OCF-Code aus HBCI4Java
 * 2.5.8.
 */
public abstract class DDVCardService extends HBCICardService {
    ...
    public int readSigId() {
        ...
        if (rawData != null) ret = ((rawData[0] << 8) & 0xFF00) | (rawData[1] & 0xFF);
