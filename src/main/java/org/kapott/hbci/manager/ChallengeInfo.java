...
public class ChallengeInfo {
    ...
    private ChallengeInfo() {
        ...
        if (dataStream == null)
            throw new InvalidUserDataException(
                    "*** can not load challenge information from " + filename);
    ...
    public static synchronized ChallengeInfo getInstance() {
        if (singleton == null) singleton = new ChallengeInfo();
        return singleton;
    }
    ...
    public void applyParams(HBCIJobImpl task, HBCIJob hktan, Properties secmech) {
        ...
        for (int i = 0; i < params.size(); ++i) {
            ...
            if (value == null || value.length() == 0) {
                HBCIUtils.log(
                        "challenge parameter " + num + " (" + param.path + ") is empty",
                        HBCIUtils.LOG_DEBUG2);
                continue;
            }
    ...
    public static class HhdVersion {
        ...
        private HhdVersion(Element spec) {
            this.klass =
                    ((Element) spec.getElementsByTagName("klass").item(0))
                            .getFirstChild()
                            .getNodeValue();
    ...
    public static class Param {
        ...
        /**
         * Optional: Der Name einer Bedingung, die erfuellt sein muss, damit der Parameter verwendet
         * wird. Konkret ist hier der Name eines Property aus secmechInfo gemeint. Also ein
         * BPD-Parameter.
         */
        ...
        /**
         * Liefert true, wenn entweder keine Bedingung angegeben ist oder die Bedingung erfuellt ist
         * und der Parameter verwendet werden kann.
         *
         * @param secmech die BPD-Informationen zum TAN-Verfahren.
         * @return true, wenn der Parameter verwendet werden kann.
         */
        public boolean isComplied(Properties secmech) {
            if (this.conditionName == null || this.conditionName.length() == 0) return true;
        ...
        /**
         * Formatiert den Text abhaengig vom Typ. Wenn kein Typ angegeben ist, wird der Wert
         * unformatiert zurueckgegeben.
         *
        ...
        public String format(String value) {
            ...
            if (this.type == null || this.type.trim().length() == 0) return value;
            ...
            try {
                ...
                if (syntax != null) factory.unuseObject(syntax, this.type);
            }
        }
    }
}
