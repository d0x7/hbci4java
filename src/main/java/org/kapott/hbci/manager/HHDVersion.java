...
public enum HHDVersion {
    /**
     * HHD-Version 1.4 Zur HKTAN-Segment-Version: Genau wissen wir es nicht, aber HHD 1.4 ist
     * wahrscheinlich.
     */
    HHD_1_4(Type.CHIPTAN, "HHD1.4", "1.4", 5, "hhd14"),

    /**
     * HHD-Version 1.3 Zur HKTAN-Segment-Version: 1.4 ist in HKTAN4 noch nicht erlaubt, damit bleibt
     * eigentlich nur 1.3
     */
    HHD_1_3(Type.CHIPTAN, "HHD1.3", "1.3", 4, "hhd13"),

    /**
     * Server-seitig generierter Matrix-Code (photoTAN) ZKA-Version und HKTAN-Version bleiben hier
     * frei, weil wir anhand diesen Merkmalen das Matrix-Code-Verfahren nicht eindeutig erkennen
     * koennen. Und da chipTAN/smsTAN deutlich gebrauechlicher ist, ist es erheblich
     * wahrscheinlicher, dass dann nicht Matrix-Code ist. Generell unterstuetzen wir nur
     * server-seitig generierte Matrix-Codes.
     */
     ...
     * @param idStart Technische Kennung beginnt mit diesem Text. Siehe "Belegungsrichtlinien
     *     TANve1.4 mit Erratum 1-3 final version vom 2010-11-12.pdf" Der Name ist standardisiert,
     *     wenn er mit "HHD1...." beginnt, ist das die HHD-Version
    ...
    public static HHDVersion find(Properties secmech) {
        HBCIUtils.log(
                "trying to determine HHD version for secmech: " + secmech, HBCIUtils.LOG_DEBUG);
        ...
        if (version != null && version.length() > 0) {
            for (HHDVersion v : values()) {
                ...
                if (s == null) continue;
                if (version.startsWith(s)) return v;
            }
        }
