...
public abstract class AbstractHBCICallback implements HBCICallback {
     ...
     */
    protected String createDefaultLogLine(
            String msg, int level, Date date, StackTraceElement trace) {
    ...
    public final synchronized void status(HBCIPassport passport, int statusTag, Object o) {
