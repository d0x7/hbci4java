...
public interface ISEPAParser {
    /**
     * Parst SEPA-XML-Daten aus dem Stream und schreib die Ergebnisse in die Liste von
     * Properties-Objekten.
     *
     * @param xml der Stream mit den XML-Daten.
     * @param target Die Liste mit Properties. Pro Geschaeftsvorfall wird ein Properties-Objekt
     *     eingefuegt.
     */
