...
public class SepaUtil {
     ...
     *
     * @param isoDate optional. Das zu verwendende Datum. Wird es weggelassen, dann wird das
     *     aktuelle Datum (mit Uhrzeit) verwendet.
     ...
     * @param format das zu verwendende Format. Fuer Beispiele siehe {@link SepaUtil#DATE_FORMAT}
     *     {@link SepaUtil#DATETIME_FORMAT} Wenn keines angegeben ist, wird per Default {@link
     *     SepaUtil#DATE_FORMAT} verwendet.
     ...
     * Betrag zurückgeliefert. Mehrfachtransaktionen müssen die gleiche Währung verwenden, da eine
     * Summenbildung sonst nicht möglich ist.
     *
    ...
    public static BigDecimal sumBtgValue(Properties sepaParams, Integer max) {
        if (max == null) return new BigDecimal(sepaParams.getProperty("btg.value"));
    ...
    /**
     * Liefert den Wert des Properties oder den Default-Wert. Der Default-Wert wird nicht nur bei
     * NULL verwendet sondern auch bei Leerstring.
     *
