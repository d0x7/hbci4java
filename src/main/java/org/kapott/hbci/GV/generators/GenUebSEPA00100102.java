...
public class GenUebSEPA00100102 extends AbstractSEPAGenerator {
    ...
    private CreditTransferTransactionInformation2 createCreditTransferTransactionInformation2(
            Properties sepaParams, Integer index) {
        CreditTransferTransactionInformation2 cdtTrxTxInf =
                new CreditTransferTransactionInformation2();
