...
public class GenLastSEPA00800101 extends AbstractSEPAGenerator {
    ...
    public void generate(Properties sepaParams, OutputStream os, boolean validate)
        ...
        ArrayList<DirectDebitTransactionInformation2> drctDbtTxInfs =
                (ArrayList<DirectDebitTransactionInformation2>) pmtInf.getDrctDbtTxInf();
        if (maxIndex != null) {
    ...
    private DirectDebitTransactionInformation2 createDirectDebitTransactionInformation2(
        ...
        drctDbtTxInf
                ...
                .getId()
                .getPrvtId()
                .setOthrId(new RestrictedIdentification2());
        drctDbtTxInf
                .getDrctDbtTx()
                .getCdtrSchmeId()
                .getId()
        ...
        if (amend) {
            drctDbtTxInf
                    .getDrctDbtTx()
                    .getMndtRltdInf()
                    .setAmdmntInfDtls(new AmendmentInformationDetails4());
            drctDbtTxInf
                    .getDrctDbtTx()
                    .getMndtRltdInf()
                    .getAmdmntInfDtls()
                    .setOrgnlDbtrAgt(new FinancialInstitution3());
            drctDbtTxInf
                    .getDrctDbtTx()
                    .getMndtRltdInf()
                    .getAmdmntInfDtls()
                    .getOrgnlDbtrAgt()
                    .setFinInstnId(new FinancialInstitutionIdentification5());
            drctDbtTxInf
                    .getDrctDbtTx()
                    .getMndtRltdInf()
                    .getAmdmntInfDtls()
                    .getOrgnlDbtrAgt()
                    .getFinInstnId()
                    .setPrtryId(new RestrictedIdentification1());
            drctDbtTxInf
                    .getDrctDbtTx()
                    .getMndtRltdInf()
                    .getAmdmntInfDtls()
        ...
        drctDbtTxInf
                .getInstdAmt()
                .setCcy(sepaParams.getProperty(SepaUtil.insertIndex("btg.curr", index)));
