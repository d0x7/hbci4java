    ...
    private DirectDebitTransactionInformationSDD createDirectDebitTransactionInformationSDD(
        ...
        if (amend) {
            ...
            drctDbtTxInf
                    ...
                    .getMndtRltdInf()
                    .getAmdmntInfDtls()
                    .setOrgnlDbtrAcct(new CashAccountSEPAMandate());
            drctDbtTxInf
                    .getDrctDbtTx()
                    .getMndtRltdInf()
                    .getAmdmntInfDtls()
                    .getOrgnlDbtrAcct()
                    .setId(new AccountIdentificationSEPAMandate());
            drctDbtTxInf
                    .getDrctDbtTx()
                    .getMndtRltdInf()
                    .getAmdmntInfDtls()
                    .getOrgnlDbtrAcct()
                    .getId()
                    .setOthr(new GenericAccountIdentificationSEPA());
            drctDbtTxInf
                    .getDrctDbtTx()
                    .getMndtRltdInf()
                    .getAmdmntInfDtls()
        ...
        if (bic != null && bic.length() > 0) {
            ...
            drctDbtTxInf
                    ...
                    .getFinInstnId()
                    .getOthr()
                    .setId(OthrIdentificationCode.NOTPROVIDED);
        }
