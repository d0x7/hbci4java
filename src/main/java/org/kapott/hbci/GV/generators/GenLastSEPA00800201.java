...
public class GenLastSEPA00800201 extends AbstractSEPAGenerator {
    ...
    public void generate(Properties sepaParams, OutputStream os, boolean validate)
        ...
        if (batch != null) doc.getPain00800101().getGrpHdr().setBtchBookg(batch.equals("1"));
        ...
        ArrayList<PaymentInstructionInformationSDD> pmtInfs =
                (ArrayList<PaymentInstructionInformationSDD>) doc.getPain00800101().getPmtInf();
        ...
        try {
            ...
            throw new HBCI_Exception(
                    "Lastschrift-Art "
                            + type
                            + " wird in der SEPA-Version 008.002.01 Ihrer Bank noch nicht unterstützt",
                    e);
        }
    ...
    private DirectDebitTransactionInformationSDD createDirectDebitTransactionInformationSDD(
        ...
        drctDbtTxInf
                ...
                .getCdtrSchmeId()
                .getId()
                .setPrvtId(new PersonIdentificationSDD2());
        drctDbtTxInf
                .getDrctDbtTx()
                .getCdtrSchmeId()
                .getId()
                .getPrvtId()
                .setOthrId(new GenericIdentificationSDD());
        drctDbtTxInf
                .getDrctDbtTx()
                .getCdtrSchmeId()
                .getId()
        ...
        drctDbtTxInf
                ...
                .getPrvtId()
                .getOthrId()
                .setIdTp(RestrictedSEPACode.SEPA);
        ...
        if (amend) {
            ...
            drctDbtTxInf
                    ...
                    .getMndtRltdInf()
                    .getAmdmntInfDtls()
                    .setOrgnlDbtrAgt(new BranchAndFinancialInstitutionIdentificationSDD2());
            drctDbtTxInf
                    .getDrctDbtTx()
                    .getMndtRltdInf()
                    .getAmdmntInfDtls()
                    .getOrgnlDbtrAgt()
                    .setFinInstnId(new FinancialInstitutionIdentificationSDD2());
            drctDbtTxInf
                    .getDrctDbtTx()
                    .getMndtRltdInf()
                    .getAmdmntInfDtls()
                    .getOrgnlDbtrAgt()
                    .getFinInstnId()
                    .setPrtryId(new RestrictedIdentificationSDD());
            drctDbtTxInf
                    .getDrctDbtTx()
                    .getMndtRltdInf()
                    .getAmdmntInfDtls()
