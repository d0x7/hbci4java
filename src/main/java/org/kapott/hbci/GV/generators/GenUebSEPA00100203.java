...
public class GenUebSEPA00100203 extends AbstractSEPAGenerator {
    ...
    private CreditTransferTransactionInformationSCT createCreditTransferTransactionInformationSCT(
            Properties sepaParams, Integer index) {
        CreditTransferTransactionInformationSCT cdtTrxTxInf =
                new CreditTransferTransactionInformationSCT();
        ...
        cdtTrxTxInf
                ...
                .setCcy(
                        ActiveOrHistoricCurrencyCodeEUR
                                .EUR); // FIXME: Schema sagt es gibt nur eur aber besser wäre
                                       // bestimmt
