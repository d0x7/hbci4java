...
public abstract class AbstractGVLastSEPA extends AbstractSEPAGV {
    private static final PainVersion DEFAULT = PainVersion.PAIN_008_001_01;
     ...
     */
    public AbstractGVLastSEPA(
            HBCIHandler handler, String lowlevelName, AbstractGVRLastSEPA result) {
        ...
        // Ziel-Datum fuer den Einzug. Default: 1999-01-01 als Platzhalter fuer "zum
        // naechstmoeglichen
        // Zeitpunkt
        // Datum als java.util.Date oder als ISO-Date-String im Format yyyy-MM-dd
        addConstraint(
                "targetdate", "sepa.targetdate", SepaUtil.DATE_UNDEFINED, LogFilter.FILTER_NONE);

        // Der folgende Constraint muss in der jeweiligen abgeleiteten Klasse passend gesetzt
        // werden.
