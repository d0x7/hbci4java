...
public class GVDauerSEPANew extends AbstractSEPAGV {
    ...
    public GVDauerSEPANew(HBCIHandler handler) {
        ...
        // Constraints für die PmtInfId (eindeutige SEPA Message ID) und EndToEndId (eindeutige ID
        // um
        ...
        addConstraint(
                "endtoendid", "sepa.endtoendid", ENDTOEND_ID_NOTPROVIDED, LogFilter.FILTER_NONE);
                    ...
                    if (st != null) {
                        ...
                        if (!st.equals("00") && !twoDigitValueInList(value2, st)) {
                            ...
                            if (!HBCIUtilsInternal.ignoreError(
                                    ...
                                    msg)) throw new InvalidUserDataException(msg);
                        }
                    }
