 ...
 *
 * <p>Die folgende Demo zeigt mit dem minimal noetigen Code, wie eine Umsatz-Abfrage fuer ein Konto
 * durchgefuehrt werden kann. Hierzu wird der Einfachheit halber das Verfahren PIN/TAN verwendet, da
 * es von den meisten Banken unterstuetzt wird.
 *
 * <p>Trage vor dem Ausfuehren des Programms die Zugangsdaten zu deinem Konto ein.
 */
public class UmsatzAbrufPinTan {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // In der Passport-Datei speichert HBCI4Java die Daten des Bankzugangs (Bankparameterdaten,
        // Benutzer-Parameter, etc.).
        // Die Datei kann problemlos geloescht werden. Sie wird beim naechsten mal automatisch neu
        // erzeugt,
        ...
        // Server-Adresse angeben. Koennen wir entweder manuell eintragen oder direkt von HBCI4Java
        // ermitteln lassen
        ...
        try {
            ...
            if (!saldoResult.isOK()) error(saldoResult.toString());
            ...
            // Sicherstellen, dass sowohl Passport als auch Handle nach Beendigung geschlossen
            // werden.
    ...
    private static class MyHBCICallback extends AbstractHBCICallback {
        /**
         * @see org.kapott.hbci.callback.HBCICallback#log(java.lang.String, int, java.util.Date,
        ...
        /**
         * @see
         *     org.kapott.hbci.callback.HBCICallback#callback(org.kapott.hbci.passport.HBCIPassport,
        ...
        public void callback(
            ...
            // Diese Funktion ist wichtig. Ueber die fragt HBCI4Java die benoetigten Daten von uns
            // ab.
            switch (reason) {
