 ...
 * ********************************************************************
 *
 * <p>Copyright (c) by Olaf Willuhn All rights reserved
 *
 * <p>********************************************************************
 */
...
public class PainVersion implements Comparable<PainVersion> {
    ...
    public static PainVersion PAIN_001_001_02 =
            new PainVersion(1, "urn:sepade:xsd:pain.001.001.02", "pain.001.001.02.xsd");

    @SuppressWarnings("javadoc")
    public static PainVersion PAIN_001_002_02 =
            new PainVersion(2, "urn:swift:xsd:$pain.001.002.02", "pain.001.002.02.xsd");

    @SuppressWarnings("javadoc")
    public static PainVersion PAIN_001_002_03 =
            new PainVersion(
                    3, "urn:iso:std:iso:20022:tech:xsd:pain.001.002.03", "pain.001.002.03.xsd");

    @SuppressWarnings("javadoc")
    public static PainVersion PAIN_001_003_03 =
            new PainVersion(
                    4, "urn:iso:std:iso:20022:tech:xsd:pain.001.003.03", "pain.001.003.03.xsd");

    @SuppressWarnings("javadoc")
    public static PainVersion PAIN_001_001_03 =
            new PainVersion(
                    5, "urn:iso:std:iso:20022:tech:xsd:pain.001.001.03", "pain.001.001.03.xsd");

    @SuppressWarnings("javadoc")
    public static PainVersion PAIN_002_002_02 =
            new PainVersion(1, "urn:swift:xsd:$pain.002.002.02", "pain.002.002.02.xsd");

    @SuppressWarnings("javadoc")
    public static PainVersion PAIN_002_003_03 =
            new PainVersion(
                    2, "urn:iso:std:iso:20022:tech:xsd:pain.002.003.03", "pain.002.003.03.xsd");

    @SuppressWarnings("javadoc")
    public static PainVersion PAIN_002_001_03 =
            new PainVersion(
                    3, "urn:iso:std:iso:20022:tech:xsd:pain.002.001.03", "pain.002.001.03.xsd");

    @SuppressWarnings("javadoc")
    public static PainVersion PAIN_008_001_01 =
            new PainVersion(1, "urn:sepade:xsd:pain.008.001.01", "pain.008.001.01.xsd");

    @SuppressWarnings("javadoc")
    public static PainVersion PAIN_008_002_01 =
            new PainVersion(2, "urn:swift:xsd:$pain.008.002.01", "pain.008.002.01.xsd");

    @SuppressWarnings("javadoc")
    public static PainVersion PAIN_008_002_02 =
            new PainVersion(
                    3, "urn:iso:std:iso:20022:tech:xsd:pain.008.002.02", "pain.008.002.02.xsd");

    @SuppressWarnings("javadoc")
    public static PainVersion PAIN_008_003_02 =
            new PainVersion(
                    4, "urn:iso:std:iso:20022:tech:xsd:pain.008.003.02", "pain.008.003.02.xsd");

    @SuppressWarnings("javadoc")
    public static PainVersion PAIN_008_001_02 =
            new PainVersion(
                    5, "urn:iso:std:iso:20022:tech:xsd:pain.008.001.02", "pain.008.001.02.xsd");

    private static final Map<Type, List<PainVersion>> knownVersion =
            new HashMap<Type, List<PainVersion>>() {
                {
                    put(
                            Type.PAIN_001,
                    ...
                    put(
                            ...
                            Collections.unmodifiableList(
                                    Arrays.asList(
                                            PAIN_002_002_02, PAIN_002_003_03, PAIN_002_001_03)));
                    put(
                            Type.PAIN_008,
                            Collections.unmodifiableList(
                                    Arrays.asList(
     ...
     * @param urn URN. In der Form "urn:iso:std:iso:20022:tech:xsd:pain.001.002.03" oder in der
     *     alten Form "sepade.pain.001.001.02.xsd".
     * @param file Dateiname der Schema-Datei.
     */
     ...
     *
     * @param xml der XML-Stream. Achtung: Da der Stream hierbei gelesen werden muss, sollte eine
     *     Kopie des Streams uebergeben werden. Denn nach dem Lesen des Streams, kann er nicht
     *     erneut gelesen werden. Der Stream wird von dieser Methode nicht geschlossen. Das ist
     *     Aufgabe des Aufrufers.
     * @return die ermittelte PAIN-Version oder NULL wenn das XML-Document keine entsprechenden
    ...
    /**
     * Die Bank sendet in ihren Antworten sowohl den SEPA-Deskriptor als auch die SEPA-Daten (die
     * XML-Datei) selbst. Diese Funktion ermittelt sowohl aus dem SEPA-Deskriptor als auch aus den
     * SEPA-Daten die angegebene PAIN-Version und vergleicht beide. Stimmen sie nicht ueberein, wird
     * eine Warnung ausgegeben. Die Funktion liefert anschliessend die zum Parsen passende Version
     * zurueck. Falls sich die angegebenen Versionen unterscheiden, wird die in den XML-Daten
     * angegebene Version zurueckgeliefert. Siehe
     * https://www.willuhn.de/bugzilla/show_bug.cgi?id=1806
     *
     * @param sepadesc die in der HBCI-Nachricht angegebene PAIN-Version.
     * @param sepadata die eigentlichen XML-Daten.
     * @return die zum Parsen zu verwendende PAIN-Version. NULL, wenn keinerlei Daten angegeben
     *     wurden.
     */
    public static PainVersion choose(String sepadesc, String sepadata) {
        ...
        try {
            ...
            final PainVersion versionData =
                    haveData
                            ? PainVersion.autodetect(
                                    new ByteArrayInputStream(sepadata.getBytes(Comm.ENCODING)))
                            : null;
    ...
    /**
     * Liefert einen String "<URN> <FILE>" zurueck, der im erzeugten XML als "xsi:schemaLocation"
    ...
    /**
     * Prueft, ob die angegebene PAIN-Version fuer den angegebenen Job von HBCI4Java unterstuetzt
     * wird.
     *
     * @param jobName der Job-Name. Z.Bsp. "UebSEPA".
    ...
    public int compareTo(PainVersion v) {
        if (v.type != this.type)
            throw new IllegalArgumentException(
                    "pain-type incompatible: " + v.type + " != " + this.type);
