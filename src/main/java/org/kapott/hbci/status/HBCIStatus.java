...
/**
 * Menge zusammengehöriger Status-Informationen. In Objekten dieser Klasse kann eine Menge von
 * HBCI-Statuscodes sowie eine Menge von Exceptions gespeichert werden. Der Sinn dieser Klasse ist
 * die Zusammenfassung von mehreren Status-Informationen, die logisch zusammengehören (z.B. alle
 * Status-Informationen, die ein bestimmtes Nachrichtensegment betreffen).
 *
 * <p>Objekte dieser Klasse werden beispielsweise in {@link org.kapott.hbci.status.HBCIMsgStatus}
...
public final class HBCIStatus {
    ...
    /**
     * Statuscode für "Gesamtstatus kann nicht ermittelt werden". (z.B. weil gar keine Informationen
     * in diesem Objekt enthalten sind)
     */
     ...
     *
     * @return Array mit <code>HBCIRetVal</code>s, die während der HBCI-Kommunikation aufgetreten
     *     sind.
     */
    ...
    /**
     * Gibt einen Code zurück, der den zusammengefassten Status aller in diesem Objekt gespeicherten
     * Rückgabewerte beschreibt. Dafür gibt es folgende Möglichkeiten:
     *
     * <ul>
     *   <li><code>STATUS_OK</code> wird zurückgegeben, wenn es keine Fehlermeldungen oder
     *       Exceptions gegeben hat und mindestens eine Erfolgsmeldung oder Warnung enthalten ist
     *   <li><code>STATUS_ERR</code> wird zurückgegeben, wenn wenigstens eine Exception aufgetreten
     *       ist oder wenigstens eine Fehlermeldung enthalten ist.
     *   <li><code>STATUS_UNKNOWN</code> wird zurückgegeben, wenn keine der beiden o.g. Bedingungen
     *       zutrifft.
     * </ul>
     *
    ...
    /**
     * Gibt <code>true</code> zurück, wenn keine Fehlermeldungen bzw. Exceptions aufgetreten sind
     * und wenigstens eine Successmeldung oder Warnung enthalten ist
     */
    public boolean isOK() {
    ...
    /**
     * Gibt einen String zurück, der alle Fehlermeldungen der hier enthaltenen Rückgabewerte im
     * Klartext enthält. Für evtl. enthaltene Exception wird die entsprechende Beschreibung in Kurz
     * (siehe {@link org.kapott.hbci.manager.HBCIUtils#exception2StringShort(Exception)}) benutzt.
     *
    ...
    /**
     * Gibt die Status-Informationen aller enthaltenen Exceptions und HBCI-Rückgabewerte als ein
     * String zurück.
     *
