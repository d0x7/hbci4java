...
/**
 * Ergebnisse einer Saldenabfrage. Hier ist für jedes abgefragte Konto genau ein entsprechendes
 * Saldo-Objekt eingetragen.
 */
public final class GVRSaldoReq extends HBCIJobResultImpl {
    ...
    /**
     * Gibt alle verfügbaren Saldo-Informationen in einem Feld zurück. Dabei existiert für jedes
     * abgefragte Konto ein Eintrag in diesem Feld.
     *
    ...
    public static final class Info implements Serializable {
        ...
        public String toString() {
            ...
            if (kredit != null) ret.append("  Kredit: ").append(kredit.toString()).append(linesep);
            if (available != null)
                ret.append("  Verfügbar: ").append(available.toString()).append(linesep);
            if (used != null) ret.append("  Benutzt: ").append(used.toString());
