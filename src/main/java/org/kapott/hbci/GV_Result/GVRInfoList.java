...
/**
 * Rückgabedaten für die Abfrage verfügbarer Kreditinstitutsinformationen. Es wird eine Liste mit
 * allen verfügbaren Informationen gespeichert, wobei jeder Eintrag Daten über genau eine KI-Info
 * enthält.
 */
public final class GVRInfoList extends HBCIJobResultImpl {
    ...
    public static final class Info {
         ...
         *
         * <ul>
         *   <li>F für Freitextmeldung (siehe {@link org.kapott.hbci.GV_Result.GVRInfoOrder})
         *   <li>S es handelt sich um ein Schriftdokument, welches bestellt werden kann
         *   <li>T für Themenüberschrift
         * </ul>
         */
        ...
        public Date date;
        /**
         * Kommentare zu dieser Information. Dieses Array ist niemals <code>null</code>, kann aber
        ...
        public String toString() {
            ...
            if (type.equals("F")) ret.append("Freitextmeldung");
            else if (type.equals("D")) ret.append("Datei");
            else if (type.equals("S")) ret.append("Schriftdokument");
            else if (type.equals("T")) ret.append("Themenueberschrift");

            if (format != null) ret.append("(").append(format).append(")");

            ret.append(" ").append(code).append(" ").append(description);
            if (date != null) ret.append(" ").append(HBCIUtils.date2StringLocal(date));
            ret.append(linesep);
