...
/**
 * Diese Klasse enthält Informationen über aktuelle TAN-Listen des Kunden. Dabei wird für jede
 * TAN-Liste ein separates Objekt erzeugt. Innerhalb einer TAN-Listen-Informationen gibt es zu jeder
 * verbrauchten TAN genauere Daten.
 */
public class GVRTANList extends HBCIJobResultImpl {
    ...
    public static class TANInfo {
         ...
         *
         * <ul>
         *   <li>0 - TAN wurde noch nicht verbraucht
         *   <li>1 - Stornierung einer Überweisung
         *   <li>2 - PIN-Änderung
         *   <li>3 - Aufheben der Kontosperre
         *   <li>4 - Aktivieren einer neuen TAN-Liste
         *   <li>5 - TAN wurde maschinell entwertet
         *   <li>6 - Mitteilungsversand
         *   <li>7 - Überweisung/Lastschrift
         *   <li>8 - Wertpapierverwaltung
         *   <li>9 - Dauerauftragsverwaltung
         *   <li>... (siehe Sourcecode)
         * </ul>
         */
        ...
        /**
         * Erläuterung für TAN-Verwendung. Wenn {@link #usagecode}==<code>99</code> ist, dann
         * enthält dieser String optional einen erläuternden Text, wofür die TAN verbraucht wurde.
         */
        public String usagetxt;

        /**
         * Die TAN selbst. Ist nur dann gesetzt, wenn die TAN tatsächlich bereits verbraucht wurde,
         * sonst ist dieses Feld <code>null</code>
         */
        public String tan;

        /**
         * Zeitpunkt, wann die TAN verbraucht wurde. Diese Variable ist nur dann ungleich <code>null
         * </code>, wenn die TAN tatsächlich bereits verbraucht wurde
         */
        ...
        public String toString() {
            ...
            return "TAN:"
                    ...
                    + ")"
                    + (timestamp != null
                            ? (" Zeitpunkt:" + HBCIUtils.datetime2StringLocal(timestamp))
                            : "");
        }
    }
    ...
    public static class TANList {
         ...
         * <ul>
         *   <li>A - aktive Liste
         *   <li>N - Noch nicht freigeschaltete Liste
         *   <li>S - Sperre der Liste
         *   <li>V - vorherige Liste
         * </ul>
         */
        public char status;
        /** Listennummer */
        ...
        public String toString() {
            ...
            ret.append("nofTANsPerList: ")
                    .append(nofTANsPerList)
                    .append("; nofUsedTANsPerList: ")
                    .append(nofUsedTANsPerList + linesep);
