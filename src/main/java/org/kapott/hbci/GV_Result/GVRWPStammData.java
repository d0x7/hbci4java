...
/**
 * Diese Klasse kann noch nicht benutzt werden, fuer die Abfrage von WP-Stammdaten muss noch der
 * Lowlevel-Job WPStammList verwendet werden.
 */
public class GVRWPStammData extends HBCIJobResultImpl {
    ...
    public static final class Entry {
        ...
        String longname;
        /**
         * Bezeichnung der Wertpapiergattung, unter der das Papier beim Kreditinstitut geführt wird
         * (optional)
         */
        String gattung;
        /**
         ...
         * <ul>
         *   <li>{@link #REGION_BOTH}
         *   <li>{@link #REGION_ONLYHOME}
         *   <li>{@link #REGION_ONLYFORGN}
         *   <li>-1 wenn nicht gesetzt
         * </ul>
         */
        int region;
         ...
         *
         * <ul>
         *   <li>{@link #EINHEIT_STCK}
         *   <li>{@link #EINHEIT_PRCT}
         *   <li>{@link #EINHEIT_PRML}
         *   <li>{@link #EINHEIT_PNKT}
         *   <li>{@link #EINHEIT_ELSE}
         * </ul>
         */
        int effekteinheit;
        /**
         ...
         *
         * <ul>
         *   <li>{@link #ORDER_ONLYBUY}
         *   <li>{@link #ORDER_ONLYSELL}
         *   <li>{@link #ORDER_BOTH}
         *   <li>{@link #ORDER_ONLYXETRA}
         * </ul>
         */
        int canorder;
        /** Nennwert (optional) */
