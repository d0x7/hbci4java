...
/**
 * Rückgabedaten für die Abfrage von Festgeld-Konditionen. Es wird eine Liste mit empfangenen
 * Konditionen bereitgestellt. Für jeden Datensatz wird ein separates Objekt mit den entsprechenden
        ...
        public String toString() {
            ...
            if (version != null)
                ret.append(" V")
                        .append(version)
                        .append(" ")
                        .append(HBCIUtils.datetime2StringLocal(date));
            ret.append(linesep);
            ...
            ret.append(" bis ");
            if (maxbetrag != null) ret.append(maxbetrag.toString());
            else ret.append("(unbegrenzt)");
            ret.append(linesep);

            ret.append("  Zinssatz: ");
            ret.append(
                    HBCIUtilsInternal.bigDecimal2String(
                            new BigDecimal(zinssatz).divide(new BigDecimal("1000.0"))));
            ret.append("% (");
            switch (zinsmethode) {
