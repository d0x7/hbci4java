 ...
 * angefordert, so werden diese nicht per Post zugestellt. Statt dessen können diese Informationen
 * mit Hilfe dieser Klasse direkt ausgewertet werden. Es wird eine Liste aller empfangenen
 * Freitextmeldungen gespeichert.
 */
