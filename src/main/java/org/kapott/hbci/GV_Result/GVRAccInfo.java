...
public class GVRAccInfo extends HBCIJobResultImpl {
     ...
     *
     * @return Array mit einzelnen Konto-Informationen. Das Array ist niemals <code>null</code>,
    ...
    public static class AccInfo {
         ...
         *
         * <ul>
         *   <li>1-9 - Kontokorrent-/Girokonto
         *   <li>10-19 - Sparkonto
         *   <li>20-29 - Festgeldkonto (Termineinlagen)
         *   <li>30-39 - Wertpapierdepot
         *   <li>40-49 - Kredit-/Darlehenskonto
         *   <li>50-59 - Kreditkartenkonto
         *   <li>60-69 - Fondsdepot bei einer Kapitalanlagegesellschaft
         *   <li>70-79 - Bausparvertrag
         *   <li>80-89 - Versicherungsvertrag
         *   <li>90-99 - Sonstige
         * </ul>
         *
         ...
         *
         * <ul>
         *   <li><code>DELIVER_TYPE_NONE</code> - kein Auszug
         *   <li><code>DELIVER_TYPE_POST</code> - Postzustellung
         *   <li><code>DELIVER_TYPE_KAD</code> - Kontoauszugsdrucker
         *   <li><code>DELIVER_TYPE_OFFICE</code> - Abholung in Geschäftsstelle
         *   <li><code>DELIVER_TYPE_EDV</code> - elektronische Übermittlung
         * </ul>
         */
        public int versandart;
        /**
         * Turnus für Kontoauszugszustellung (nur bei Postzustellung) (optional). Folgende Werte
         * sind definiert:
         *
         * <ul>
         *   <li><code>TURNUS_DAILY</code> - täglicher Kontoauszug
         *   <li><code>TURNUS_WEEKLY</code> - wöchentlicher Kontoauszug
         *   <li><code>TURNUS_MONTHLY</code> - monatlicher Kontoauszug
         *   <li><code>TURNUS_QUARTER</code> - vierteljährlicher Kontoauszug
         *   <li><code>TURNUS_HALF</code> - halbjährlicher Kontoauszug
         *   <li><code>TURNUS_ANNUAL</code> - jährlicher Kontoauszug
         * </ul>
         */
        public int turnus;
        ...
        public String toString() {
            ...
            if (created != null)
                ret.append("Eröffnungsdatum: ")
                        .append(HBCIUtils.date2StringLocal(created))
                        .append(linesep);
            ret.append("Sollzins:")
                    .append(
                            HBCIUtilsInternal.bigDecimal2String(
                                    new BigDecimal(sollzins).divide(ONE_THOUSAND)));
            ret.append(" Habenzins:")
                    .append(
                            HBCIUtilsInternal.bigDecimal2String(
                                    new BigDecimal(habenzins).divide(ONE_THOUSAND)));
            ret.append(" Überziehungszins:")
                    .append(
                            HBCIUtilsInternal.bigDecimal2String(
                                    new BigDecimal(ueberzins).divide(ONE_THOUSAND)));
            ...
            if (comment != null) ret.append("Bemerkungen: ").append(comment).append(linesep);
