...
/**
 * Klasse mit den Ergebissen der Abfrage von Informationen zu ausgegebenen Karten. Für jede Karte,
 * für die Informationen verfügbar sind, wird eine separates Informationsobjekt {@link
 * org.kapott.hbci.GV_Result.GVRCardList.CardInfo} erzeugt.
 */
public class GVRCardList extends HBCIJobResultImpl {
     ...
     *
     * @return Array mit Karteninformationsdaten. Das Array selbst ist niemals <code>null</code>,
    ...
    public static class CardInfo {
        ...
        public String toString() {
            ...
            ret.append("Gültig von ")
                    .append(
                            (validFrom != null
                                    ? HBCIUtils.date2StringLocal(validFrom)
                                    : "unknown"));
            ret.append(" bis ")
                    .append(
                            (validUntil != null
                                    ? HBCIUtils.date2StringLocal(validUntil)
                                    : "unknown"))
                    .append(linesep);

            if (limit != null) ret.append("Kartenlimit: ").append(limit).append(linesep);
