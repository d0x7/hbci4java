...
/**
 * Ergebnisdaten für die Abfrage einer Depotaufstellung. Diese Klasse enthält für jedes Depot ein
 * separates Datenobjekt. Innerhalb eines Depots werden für jede in diesem Depot vorhandene
 * Wertpapiergattung separate Datenobjekte gehalten. Für jede Wertpapiergattung wiederum gibt es
 * u.U. mehrere Objekte, die Saldeninformationen enthalten.
 */
public final class GVRWPDepotList extends HBCIJobResultImpl {
    /**
     * Dieses Feld enthält einen String, der den nicht-auswertbaren Teil der gelieferten
     * Informationen enthält. Es dient nur zu Debugging-Zwecken und sollte eigentlich immer <code>
     * null</code> bzw. einen leeren String enthalten. Wenn das nicht der Fall ist, dann konnten die
     * empfangenen Daten nicht richtig geparst werden, und dieser String enthält den "Schwanz" der
     * Daten, bei dem das Parsing-Problem aufgetreten ist.
     */
    public String rest;
    ...
    /**
     * Gibt ein Array mit Depotdaten zurück, wobei jeder Eintrag Informationen zu genau einem Depot
     * enthält.
     *
    ...
    public static final class Entry {
        ...
        /**
         * Gibt ein Array mit Informationen über alle Wertpapiergattungen zurück, die in diesem
         * Depot gehalten werden. Der Rückgabewert ist niemals <code>null</code>, die Größe des
         * Arrays kann aber 0 sein.
         *
        ...
        public String toString() {
            ...
            if (total != null) ret.append("Total: ").append(total.toString());
        ...
        public static final class Gattung {
             ...
             *
             * <ul>
             *   <li>{@link #PRICE_TYPE_PRCT} - Preis ist ein Prozentsatz
             *   <li>{@link #PRICE_TYPE_VALUE} - Preis ist ein Geldbetrag
             * </ul>
             */
             ...
             *
             * <ul>
             *   <li>{@link #PRICE_QUALIF_MRKT} - Marktpreis (z.B. aktueller Börsenkurs)
             *   <li>{@link #PRICE_QUALIF_HINT} - Hinweispreis (rechnerischer bzw. ermittelter
             *       Preis)
             * </ul>
             */
            public int pricequalifier;
            /**
             * Preis pro Einheit (optional). Die Währung ist bei {@link #pricetype}={@link
             * #PRICE_TYPE_PRCT} auf "%" gesetzt.
             */
             ...
             *
             * <ul>
             *   <li>{@link #SOURCE_LOC} - lokale Börse
             *   <li>{@link #SOURCE_THEOR} - theoretischer Wert
             *   <li>{@link #SOURCE_SELLER} - Verkäufer als Quelle
             * </ul>
             */
            public int source;
            /**
             * Bemerkungen zur Herkunft von Preis/Kurs {@link #source} (optional). Bei {@link
             * #source}={@link #SOURCE_LOC} kann der Name der Börse als MIC angegeben werden
             */
             ...
             *
             * <ul>
             *   <li>{@link org.kapott.hbci.GV_Result.GVRWPDepotList.Entry#SALDO_TYPE_STCK} - Saldo
             *       ist eine Stückzahl
             *   <li>{@link org.kapott.hbci.GV_Result.GVRWPDepotList.Entry#SALDO_TYPE_WERT} - Saldo
             *       ist ein Betrag
             * </ul>
             */
            public int saldo_type;
            /**
             * Gesamtsaldo dieser Gattung. Das Währungsfeld ist in jedem Fall ein leerer String!
             * (TODO).
             */
            ...
            public Date faellig;
            /**
             * Einstandspreis/-kurs (optional). Die Währung ist "%", wenn es sich um eine
             * Prozentabgabe handelt
             */
            ...
            /**
             * Gibt alle Unter-Saldoinformationen in einem Array zurück. Der Rückgabewert ist
             * niemals <code>null</code>, das Array kann aber die Länge <code>0</code> haben.
             *
            ...
            public String toString() {
                ...
                if (price != null) {
                    ret.append("Preis: ")
                            ...
                            .append(" (")
                            .append((pricetype == PRICE_TYPE_PRCT ? "Prozent" : "Betrag"));
                    ret.append("; ")
                            .append(
                                    (pricequalifier == PRICE_QUALIF_MRKT
                                            ? "Marktpreis"
                                            : "Hinweispreis"))
                            .append(")")
                            .append(linesep);
                ...
                if (source != 0) {
                    ...
                    if (source_comment != null) ret.append(" (").append(source_comment).append(")");
                    ret.append(linesep);
                }
                ...
                if (einstandspreis != null)
                    ret.append("Einstandspreis: ")
                            .append(einstandspreis.toString())
                            .append(linesep);
                if (zinssatz != 0)
                    ret.append("Zinssatz: ")
                            .append(
                                    HBCIUtilsInternal.bigDecimal2String(
                                            new BigDecimal(zinssatz)
                ...
                ret.append("Typ:")
                        ...
                        .append(branche)
                        .append(" Emittent:")
                        .append(countryEmittent)
                        .append(linesep);
                if (kauf != null)
                    ret.append("Kauf: ").append(HBCIUtils.date2StringLocal(kauf)).append(linesep);
                if (faellig != null)
                    ret.append("Faelligkeit: ")
                            .append(HBCIUtils.date2StringLocal(faellig))
                            .append(linesep);
                if (days != 0)
            ...
            /**
             * Untersaldoinformationen, das heißt Informationen über die Zusammensetzung des Saldos
             * einer Wertpapiergattung.
             */
            public static final class SubSaldo {
                 ...
                 * <ul>
                 *   <li>{@link
                 *       org.kapott.hbci.GV_Result.GVRWPDepotList.Entry.Gattung#PRICE_TYPE_PRCT} -
                 *       Saldo ist ein Prozentsatz
                 *   <li>{@link
                 *       org.kapott.hbci.GV_Result.GVRWPDepotList.Entry.Gattung#PRICE_TYPE_VALUE} -
                 *       Saldo ist ein Geldbetrag
                 * </ul>
                 */
                public int saldo_type;
                /**
                 * Gibt an, ob das Papier für einen Verkauf zur Verfügung steht. <code>true</code>
                 * gibt an, dass das Papier gesperrt ist und somit nicht zur Verfügung steht, bei
                 * <code>false</code> kann es verkauft werden
                 */
                public boolean locked;
                /**
                 * Saldobetrag. Das Währungsfeld <code>curr</code> ist hier zur Zeit immer der leere
                 * String.
                 */
                public BigDecimalValue saldo;
                /**
                 * Lagerland der Depotstelle (optional). Der Ländercode ist der ISO-3166-Ländercode
                 ...
                 * <ul>
                 *   <li>0 - nicht gesetzt
                 *   <li>1 - Girosammelverwahrung
                 *   <li>2 - Streifbandverwahrung
                 *   <li>3 - Haussammelverwahrung
                 *   <li>4 - Wertpapierrechnung
                 *   <li>9 - Sonstige
                 * </ul>
                 */
                ...
                public String toString() {
                    ...
                    ret.append(saldo.toString())
                            .append(" (")
                            .append(((saldo_type == SALDO_TYPE_STCK) ? "STCK" : "WERT"))
                            .append(")")
                            .append(linesep);
