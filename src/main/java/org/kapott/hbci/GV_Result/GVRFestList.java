...
/**
 * Ergebnisse der Abfrage bestehender Festgeldanlange. Die verschiedenen Festgeldanlagen werden in
 * einer Liste gespeichert. Für jede bestehende Festgeldanlage gibt es ein separates Objekt mit
 * Informationen über diese Anlage.
 */
public final class GVRFestList extends HBCIJobResultImpl {
    ...
    public static final class Entry {
        ...
        /**
         * Soll die Festgeldanlage nach Ablauf des Anlagezeitraumes verlängert werden? Wenn ja, dann
         * enthält das Feld <code>verlaengerung</code> entsprechende Informationen darüber
         */
         ...
         *
         * <ul>
         *   <li>0 = Wert nicht gesetzt
         *   <li>1 = Zustellung per Post
         *   <li>2 = Abholung (Kontoauszugsdrucker)
         * </ul>
         */
        ...
        public String toString() {
            ...
            ret.append("Ausbuchungskonto: ")
                    .append(
                            (ausbuchungskonto != null
                                    ? ausbuchungskonto.toString()
                                    : belastungskonto.toString()))
                    .append(linesep);
            ret.append("Zinskonto: ")
                    .append((zinskonto != null ? zinskonto.toString() : belastungskonto.toString()))
                    .append(linesep);
            ret.append("Anlagebetrag: ").append(anlagebetrag.toString()).append(linesep);
            if (zinsbetrag != null)
                ret.append("Voraussichtlicher Zinsbetrag: ")
                        .append(zinsbetrag.toString())
                        .append(linesep);
            ret.append("Nach Ablauf verlängern: ")
                    .append(Boolean.toString(verlaengern))
                    .append(linesep);
            ret.append(konditionen.toString() + linesep);
            if (verlaengern) ret.append(linesep + verlaengerung.toString());
        ...
        public static final class Prolong {
            ...
            public Value betrag;
            /**
             * Soll Festgeldanlage nach der zusätzlichen <code>laufzeit</code> erneut verlängert
             * werden?
             */
            public boolean verlaengern;
