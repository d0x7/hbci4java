...
/**
 * Ergebnisse der Abfrage von bestehenden Daueraufträgen. In diesem Objekt wird eine Liste von
 * Dauerauftragsdaten gespeichert. Jedes dieser Dauerauftragsdaten-Objekte beschreibt dabei einen
 * bestehenden Dauerauftrag.
 */
public final class GVRDauerList extends HBCIJobResultImpl {
    ...
    public String toString() {
        ...
        for (Iterator<Dauer> i = entries.iterator(); i.hasNext(); ) {
            ret.append(HBCIUtilsInternal.getLocMsg("STANDINGORDER"))
                    .append(" #")
                    .append(i)
    ...
    public static final class Dauer {
        ...
        /**
         * Verwendungszweckzeilen. Dieses Array ist niemals <code>null</code>, kann aber die Länge
         * <code>0</code> haben.
         */
        public String[] usage;
         ...
         *
         * <ul>
         *   <li>bei Zeiteinheit=W: 1-7 für Wochentag
         *   <li>bei Zeiteinheit=M: 1-31 für Tag des Monats
         * </ul>
         */
        public int execday;
        ...
        /**
         * Aussetzung jährlich wiederholen? (Nur gültig, wenn <code>aus_available</code> <code>true
         * </code> ist)
         */
        public boolean aus_annual;
        /**
         * Tag der ersten Aussetzung (Nur gültig, wenn <code>aus_available</code> <code>true</code>
         * ist) (optional)
         */
        public Date aus_start;
        /**
         * Tag der letzten Aussetzung (Nur gültig, wenn <code>aus_available</code> <code>true</code>
         * ist) (optional)
         */
        public Date aus_end;
        /**
         * Anzahl der Aussetzungen (Nur gültig, wenn <code>aus_available</code> <code>true</code>
         * ist) (optional)
         */
        public String aus_breakcount;
        /**
         * Geänderter Betrag während Aussetzung (Nur gültig, wenn <code>aus_available</code> <code>
         * true
         * </code> ist) (optional)
         */
        ...
        public String toString() {
            ...
            ret.append("  ")
                    .append(HBCIUtilsInternal.getLocMsg("SRCACCOUNT"))
                    .append(": ")
                    .append(my.toString())
                    .append(linesep);
            ret.append("  ")
                    .append(HBCIUtilsInternal.getLocMsg("DSTACCOUNT"))
                    .append(": ")
                    .append(other.toString())
                    .append(linesep);
            ret.append("  ")
                    .append(HBCIUtilsInternal.getLocMsg("VALUE"))
                    .append(": ")
                    .append(value.toString())
                    .append(linesep);
            ret.append("  ")
                    .append(HBCIUtilsInternal.getLocMsg("KEY"))
                    .append(": ")
                    .append(key)
                    .append("/")
                    .append(addkey)
                    .append(linesep);
            ret.append("  ")
                    .append(HBCIUtilsInternal.getLocMsg("USAGE"))
                    .append(":")
                    .append(linesep);
            ...
            if (nextdate != null)
                ret.append("  ")
                        .append(HBCIUtilsInternal.getLocMsg("NEXTEXECDATE"))
                        .append(": ")
                        .append(HBCIUtils.date2StringLocal(nextdate))
                        .append(linesep);
            ret.append("  ")
                    .append(HBCIUtilsInternal.getLocMsg("ORDERID"))
                    .append(": ")
                    .append(orderid)
                    .append(linesep);

            ret.append("  ")
                    .append(HBCIUtilsInternal.getLocMsg("FIRSTLASTEXEC"))
                    .append(": ")
                    .append(HBCIUtils.date2StringLocal(firstdate))
                    .append(" / ");
            ret.append((lastdate != null ? HBCIUtils.date2StringLocal(lastdate) : "N/A"))
                    .append(linesep);
            ret.append("  ")
                    .append(HBCIUtilsInternal.getLocMsg("EXECDAY"))
                    .append(": ")
                    .append(execday)
                    .append(linesep);
            ret.append("  ")
                    .append(HBCIUtilsInternal.getLocMsg("UNITTURNUS"))
                    .append(": ")
                    .append(timeunit)
                    .append(" / ")
                    .append(turnus)
