...
public class TestBug1129 extends AbstractTest {
    ...
    /**
     * Testet das Parsen eines Responses mit ungueltigem DTAUS ohne Fehlertoleranz. Code muss einen
     * Fehler werfen.
     *
     * @throws Exception
     */
    ...
    public void test003() throws Exception {
        ...
        Assert.assertEquals(
                "EBÜHREN Z.T. IM VORAUS",
                ht.get("CustomMsgRes.GVRes_6.DauerListRes4.usage.usage_3"));
    }
}
