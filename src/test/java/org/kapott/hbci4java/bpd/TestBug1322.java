 ...
 * ********************************************************************
 *
 * <p>Copyright (c) by Olaf Willuhn All rights reserved LGPLv2
 *
 * <p>********************************************************************
 */
...
/** Test fuer die neuen grossen BPD bei der GAD. BUGZILLA 1322 */
public class TestBug1322 extends AbstractTest {
    /**
     * Versucht, die BPD mit dem ueberlangen (mehr als 999 Zeichen) HIVISS Segment in der
     * HBCI-Version "FinTS3" zu parsen.
     *
     * @throws Exception
     */
    @Test
        ...
        try {
            ...
            MSG msg =
                    MSGFactory.getInstance()
                            .createMSG("DialogInitAnonRes", data, data.length(), gen);
