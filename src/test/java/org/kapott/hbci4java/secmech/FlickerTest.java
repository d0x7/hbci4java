 ...
 * ********************************************************************
 *
 * <p>Copyright (c) 2016 Olaf Willuhn GNU LGPLv2
 *
 * <p>********************************************************************
 */
...
public class FlickerTest extends AbstractTest {
    ...
    /**
     * Testet das Parsen eines Challenge HHDuc, wie er via HBCI uebertragen wird sowie das Umwandeln
     * in den FlickerCode.
     *
     * @throws Exception
     */
    ...
    /**
     * Das ist ein "echter" HHD-1.3-Code, der nicht im Challenge-Freitext sondern tatsaechlich im
     * Challenge HHDuc uebertragen wurde. Erkennbar daran, dass das LC nur 2 Zeichen lang ist.
     * Stammt von der Postbank.
     *
     * @throws Exception
     */
    @Test
    ...
    /**
     * Das ist ein Code von einem User, der zwar korrekt als HHD 1.3 erkannt wurde - aber der Fehler
     * beim Versuch, es als HHD 1.4 zu parsen, trat zu einem Zeitpunkt auf, wo schon ein Controlbyte
     * falsch gelesen wurde. Daraufhin habe ich die neue Funktion "rest()" eingebaut, die
     * sicherstellt, dass von dem 1.4er Versuch keine Fragmente mehr uebrig sind, wenn im zweiten
     * Versuch als 1.3 gelesen wird.
     *
     * @throws Exception
     */
    @Test
    ...
    /**
     * Flickercodes von der Sparda, die diese seit KW 47/2016 verwendet. Die enthalten nur noch zwei
     * DEs - eins mit der IBAN und eins mit dem Betrag.
     *
     * @throws Exception
     */
    @Test
    ...
    public void testRender1() throws Exception {
        ...
        FlickerRenderer renderer =
                new FlickerRenderer(flicker) {
                    /**
                     * @see org.kapott.hbci.manager.FlickerRenderer#paint(boolean, boolean, boolean,
                     *     boolean, boolean)
                     */
        ...
        expected.append(
                "11111 01111 10000 00000 11111 01111 11111 01111 11011 01011 10000 00000 11010 01010 10001 00001 11000 01000 10000 00000 10000 00000 10100 00100 11010 01010 10010 00010 10000 00000 10100 00100 11001 01001 11000 01000 10001 00001 11001 01001 10010 00010 10000 00000 10100 00100 11000 01000 10010 00010 11100 01100 10110 00110 11010 01010 10001 00001 11110 01110 11010 01010 11010 01010 ");
        expected.append(
                "11111 01111 10000 00000 11111 01111 11111 01111 11011 01011 10000 00000 11010 01010 10001 00001 11000 01000 10000 00000 10000 00000 10100 00100 11010 01010 10010 00010 10000 00000 10100 00100 11001 01001 11000 01000 10001 00001 11001 01001 10010 00010 10000 00000 10100 00100 11000 01000 10010 00010 11100 01100 10110 00110 11010 01010 10001 00001 11110 01110 11010 01010 11010 01010 ");
