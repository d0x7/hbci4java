...
public class ChallengeInfoTest extends AbstractTest {
    ...
    /**
     * Testet, dass fuer eine unbekannte HHD-Version oder einen unbekannten Geschaeftsvorfall auch
     * wirklich nichts geliefert wird.
     */
    @Test
    ...
    public void testDEG() throws Exception {
        ...
        try {
            ...
            String expected =
                    "HNHBK:1:3+000000000139+300+H11051813102140+3'HKTAN:2:5+1+HKDAN+::12345678::280:12345678+@5@12345+++N+++43+:201,:12345::Param 5'HNHBS:3:1+3'";
            // ^^^^^^^^^^^^^^^^^^^^
