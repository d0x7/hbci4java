...
public class TestPainVersion {
    ...
    public void test006() throws Exception {
        List<PainVersion> list =
                new ArrayList<PainVersion>() {
                    {
        ...
        Assert.assertEquals(
                PainVersion.byURN("urn:iso:std:iso:20022:tech:xsd:pain.001.003.03"), highest);
    }
    ...
    public void test007() throws Exception {
                ...
                new ArrayList<PainVersion>() {
                    {
                        ...
                        // Bizzar, aber ist so. Der Test prueft, dass 001.001.03 die aktuellste
                        // Version ist.
                        // Siehe die Hinweise in PainVersion#compareTo
        ...
        Assert.assertNotNull(highest);
        Assert.assertEquals(
                PainVersion.byURN("urn:iso:std:iso:20022:tech:xsd:pain.001.001.03"), highest);
    }
    ...
    /**
     * Testet, dass die PAIN-Version auch dann korrekt erkannt wird, wenn sie in der alten Form
     * angegeben ist. Es gibt naemlich Banken, die in HISPAS das alte Bezeichner-Format senden (also
     * etwa "sepade.pain.001.002.03.xsd"), anschliessend aber meckern, wenn man denen beim
     * Einreichen eines Auftrages genau dieses Format uebergibt. Dort wollen die dann ploetzlich
     * stattdessen den neuen URN haben (also "urn:iso:std:iso:20022:tech:xsd:pain.001.002.03").
